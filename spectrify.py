# The aim of this code is to take a 2D numpy array of spectral values (wavelength, counts) and 'reverse engineer' the data to produce a visible spectrum image vaguely like what came out of the telescope spectrograph.  It is intended for mor intuitive visualisation of spectra for public outreach etc.
